...
public class TicketV {
    ...
    private static void processTicket(String name, String Batch, String txn)
    {
        ...
        try {
            ...
            content.moveTextPositionByAmount(140, 595);
            content.drawString(name);
            content.endText();
            
            content.beginText();
            content.setFont(fontBold, 10);
            content.moveTextPositionByAmount(140, 580);
            content.drawString(Batch);
            content.endText();
            
            content.beginText();
            content.setFont(fontBold, 10);
            content.moveTextPositionByAmount(180, 565);
            content.drawString(txn);
            content.endText();
            
            content.drawImage(image, 400, 648);
